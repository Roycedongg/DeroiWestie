...
pedigree: {
  zh: [
    ...
    "西敏寺Westminster Terrier Group 1",
    "蒙哥马利Montgomery Group 4",
    "",
    "母：DIESEL TOP Phoenix MULAN CN GCH, CN TH CH, INT CH",
    "2022 CKU Top.1 Westie",
    "Top.1 in Terrier Group",
    "梗犬单独展Group 3 BISS - Specialty Best Terrier",
    "血统特点：毛质硬，色素好，头版强",
  ],
  en: [
    ...
    "Top 1 in Terrier Group",
    "Group 3 BISS - Specialty Best Terrier",
    ...
    titles: {
      zh: [
        ...
        "BPBIS * 7",
        " BOB*23 / BIG *9",
        "梗犬单独展BIS Specialty Best Terrier",
        "性格稳定，适合家庭与赛场",
      ],
      en: [
       "PBIS * 7",
